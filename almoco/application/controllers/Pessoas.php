...
class Pessoas extends MY_Controller {
    ...
    function index($modal_sn = 'N') {
        ...
        $data['perfil'] = $this->model->listar_perfil();
    ...
    public function dados_pessoa() {
        ...
        $perfil = form_dropdown('id_perfil', $array_perfil, $consulta->row()->id_perfil, 'class="form-control" id="id_perfil"');
